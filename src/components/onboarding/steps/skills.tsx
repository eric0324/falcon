...
export function useSkillsSteps(): StepType[] {
  ...
  return [
    ...
    { selector: '[data-tour="skills-create"]', content: t("create") },
    { selector: '[data-tour="skills-card"]', content: t("card") },
    { selector: '[data-tour="skills-visibility"]', content: t("visibility") },
    {
      selector: "body",
      position: "center",
      highlightedSelectors: [],
